  ...
  def as_json(options)
    data = {
        ...
        :insurance => {
            ...
            :insured_address => patient_insurance_insured_address,
            :insured_city => patient_insurance_insured_city,
            :insured_state => patient_insurance_insured_state,
            :insured_zipcode => patient_insurance_insured_zipcode,
        },
        :client => {
            :id => user.id,
